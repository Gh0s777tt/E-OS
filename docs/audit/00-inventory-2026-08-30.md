...
- **Źródło prawdy:** GitLab (`gitlab.com/e-os/*`) — zgodnie z `docs/adr/0001-gitlab-jako-zrodlo-prawdy.md`.
...
`docs/adr/0001-gitlab-jako-zrodlo-prawdy.md` ustala GitLab jako źródło prawdy, a GitHub jako
...
| `docs/architecture.md` | 3912 B | 2026-08-16 | Boot flow · The kernel · Schemes · Component map · How E-OS differs from upstream |
...
| `ARCHITECTURE.md` | ✅ | 5,7 kB | 2026-08-14 | **3** | poprawny, ale dubluje zakres z `docs/architecture.md` bez wskazania, który jest wejściem (§6.4) |
...
własnym katalogiem — §7.2), `ROADMAP.md` (jawne archiwum — §6.5), `docs/REDOX-README.md` i
`docs/REDOX-CONTRIBUTING.md` (zachowanie atrybucji upstreamu).
