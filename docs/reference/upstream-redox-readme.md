---
title: Upstream Redox OS README (verbatim)
status: reference copy — do not edit
last-reviewed: 2026-08-30
owner: Gh0s777tt
---

> **This is a verbatim copy of the upstream Redox OS README**, kept for attribution and reference.
> Its internal links (`./LICENSE`, `CONTRIBUTING.md`) point at files in the **upstream** repository
> and are intentionally left unrewritten: correcting them would misrepresent the quoted text.
> The E-OS equivalents are [`LICENSE`](../../LICENSE) and [`CONTRIBUTING.md`](../../CONTRIBUTING.md).
...
[![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://gitlab.redox-os.org/redox-os/redox/-/blob/master/LICENSE)

## More Links

- [Book](https://doc.redox-os.org/book/)
- [Contribute](https://gitlab.redox-os.org/redox-os/redox/-/blob/master/CONTRIBUTING.md)
