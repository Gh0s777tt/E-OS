...
> in software on orbital (`docs/architecture/desktop-environment.md`). It is deferred for
...
`docs/architecture/netsurf-pie.md`. Follow-up `R-D09` (resizable window, P3) tracks the
