---
title: Tokeny — wszystko za jednym posiedzeniem
status: current
...
repozytorium**, a `docs/getting-started/install.md` i `docs/security/hardening.md` **instruują użytkowników**, żeby nim
...
* Po rotacji `RENOVATE_TOKEN` zadanie zgłasza *„Authentication failure"* — to znany objaw
  nieaktualnego tokenu, nie awaria bota (`docs/operations/ci.md`).
