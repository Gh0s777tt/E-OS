---
title: The plan — editions, compartmentalisation, and the order to build them in
status: archived
...
> version of `docs/archive/reality-ledger.md` claimed there was; it was fabricated (see `U-126`).
