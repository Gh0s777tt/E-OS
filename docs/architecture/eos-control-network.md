---
title: eos-control: the Network settings pane (live netcfg + static apply)
status: current
...
[eos-power](eos-power.md), which established the shim pattern this reuses.
...
1. `eos-netcfg` elevates via the shared [`elevate::to_root`](eos-power.md)
