...
> [Threat Model](threat-model.md), [Disk Encryption](../guides/encryption.md) and
...
2. **Encrypt the disk.** Install (or re-create) E-OS on a **RedoxFS AES-XTS-128**
   ...
   [encryption.md](../guides/encryption.md). This is the single biggest win against the
