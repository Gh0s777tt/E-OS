---
title: E-OS Full-Disk Encryption (RedoxFS)
status: current
...
> [Threat Model](../security/threat-model.md), [Hardening Guide](../security/hardening.md) and
...
the *physical / lost-device* adversary in the [threat model](../security/threat-model.md).
...
- No **TPM / Secure Boot** binding — the password alone protects the disk; an
  ...
  See the [threat model](../security/threat-model.md) non-goals.
