...
**M1 status, measured 2026-08-31:** 11 tasks tracked as GitLab issues, **5 closed** (#1 `R-611a`, #2 `R-611b`, #7 `R-607a`, #8 `R-612a`, #10 `R-608` part), 6 open. Tasks 1 (`R-611a`), 7 (`R-607a`) and 8
